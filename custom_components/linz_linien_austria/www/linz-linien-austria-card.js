...
`;var Ve,Ge;!function(e){e.language="language",e.system="system",e.comma_decimal="comma_decimal",e.decimal_comma="decimal_comma",e.space_comma="space_comma",e.none="none"}(Ve||(Ve={})),function(e){e.language="language",e.system="system",e.am_pm="12",e.twenty_four="24"}(Ge||(Ge={}));const qe=(e,t,i,n)=>{n=n||{},i=null==i?{}:i;const r=new Event(t,{bubbles:void 0===n.bubbles||n.bubbles,cancelable:Boolean(n.cancelable),composed:void 0===n.composed||n.composed});return r.detail=i,e.dispatchEvent(r),r};let Ze=class extends se{constructor(){super(...arguments),this._config={type:"linz-linien-austria-card"},this._computeLabel=e=>{const t=`ui.panel.lovelace.editor.card.generic.${e.name}`,i=this.hass?.localize?.(t);if(i)return i;const n=`editor.${e.name}`,r=Be(n,{hassLanguage:this.hass?.language});return r!==n?r:e.name},this._computeHelper=e=>{const t=`editor.${e.name}_helper`,i=Be(t,{hassLanguage:this.hass?.language});return i===t?void 0:i},this._onFormChanged=e=>{const t={...e.detail.value};this._config=t,qe(this,"config-changed",{config:t})},this._onWalkTimeChange=(e,t)=>{const i=t.target.value.trim();if(""===i)return void this._patchRecord("walk_times",e,void 0);const n=Number(i);!Number.isFinite(n)||n<=0?this._patchRecord("walk_times",e,void 0):this._patchRecord("walk_times",e,Math.round(n))},this._onLineColorChange=(e,t)=>{const i=t.target;this._patchRecord("line_colors",e,i.value)},this._onLineColorClear=e=>{this._patchRecord("line_colors",e,void 0)}}setConfig(e){this._config={...e}}_allKnownLines(){const e=new Set,t=this._config.entity;if(t&&this.hass){const i=this.hass.states[t],n=i?.attributes?.departures;if(Array.isArray(n))for(const t of n)t.line&&e.add(t.line)}for(const t of this._config.lines??[])t&&e.add(t);return this._sortLines(Array.from(e))}_availableLines(){const e=(this._config.lines??[]).map(e=>e.trim()).filter(Boolean);return e.length>0?this._sortLines(e):this._allKnownLines()}_sortLines(e){return Array.from(new Set(e)).sort((e,t)=>{const i=parseInt(e,10),n=parseInt(t,10);return Number.isNaN(i)||Number.isNaN(n)||i===n?e.localeCompare(t,void 0,{numeric:!0}):i-n})}_motForLine(e){const t=this._config.entity;if(!t||!this.hass)return;const i=this.hass.states[t],n=i?.attributes?.departures;if(Array.isArray(n))for(const t of n)if(t.line===e&&"number"==typeof t.mot)return t.mot}_defaultColorForLine(e){const t=this._motForLine(e);return 0===t||1===t?"#455a64":2===t?"#1565c0":5===t||6===t||7===t?"#6a1b9a":"#f08000"}_iconForLine(e){const t=this._motForLine(e);return 0===t||1===t?"mdi:train":2===t?"mdi:subway-variant":3===t||4===t?"mdi:tram":5===t||6===t?"mdi:bus":7===t?"mdi:bus-clock":8===t?"mdi:gondola":9===t?"mdi:ferry":10===t?"mdi:bus-multiple":"mdi:tram"}_toggleLine(e){const t=new Set(this._config.lines??[]);t.has(e)?t.delete(e):t.add(e);const i={...this._config};0===t.size?delete i.lines:i.lines=this._sortLines(Array.from(t)),this._config=i,qe(this,"config-changed",{config:i})}_onCustomLineSubmit(e){const t=e.value.trim();if(!t)return;const i=new Set(this._config.lines??[]);i.add(t);const n={...this._config,lines:this._sortLines(Array.from(i))};e.value="",this._config=n,qe(this,"config-changed",{config:n})}_renderLinesFilter(){const e=this._allKnownLines(),t=new Set(this._config.lines??[]);return D`
        ...
        ${0===e.length?D`<div class="editor-hint">
              ...
              ${e.map(e=>{const i=this._defaultColorForLine(e),n=this._iconForLine(e),r=t.has(e);return D`
                  <button
                    ...
                    aria-label="${Be("editor.lines",{hassLanguage:this.hass?.language})}: ${e}"
              ...
              <div class="per-line-row">
                ...
                <label class="per-line-walk-group">
                  <input
                    ...
                    placeholder=${Be("editor.walk_time_placeholder",{hassLanguage:this.hass?.language})}
                    aria-label="${Be("editor.walk_time",{hassLanguage:this.hass?.language})}: ${e}"
                    @change=${t=>this._onWalkTimeChange(e,t)}
                  />
                  <span class="per-line-walk-unit">
                    ${Be("editor.minutes_short",{hassLanguage:this.hass?.language})}
                  </span>
                </label>
                <label
                ...
                >
                  ...
                  <input
                    ...
                    type="color"
                    .value=${o}
                    aria-label="${Be("editor.line_color",{hassLanguage:this.hass?.language})}: ${e}"
                    title="${Be("editor.line_color",{hassLanguage:this.hass?.language})}: ${e}"
                ...
                <button
                  ...
                  type="button"
                  title=${Be("editor.line_color_clear",{hassLanguage:this.hass?.language})}
                  aria-label="${Be("editor.line_color_clear",{hassLanguage:this.hass?.language})}: ${e}"
                  ?disabled=${!r}
    ...
    `}static{this.styles=Ke}};e([pe({attribute:!1})],Ze.prototype,"hass",void 0),e([ue()],Ze.prototype,"_config",void 0),Ze=e([ce("linz-linien-austria-card-editor")],Ze),console.info(`%c  Linz Linien Austria Card  %c  v${Ee}  `,"color: white; font-weight: bold; background: #F08000","color: white; font-weight: bold; background: dimgray"),window.customCards=window.customCards||[],window.customCards.push({type:"linz-linien-austria-card",name:"Linz Linien Austria",description:"Live LINZ AG LINIEN departure monitor.",preview:!0,documentationURL:"https://github.com/rolandzeiner/linz-linien-austria"});const Ye={0:"mdi:train",1:"mdi:train",2:"mdi:subway-variant",3:"mdi:tram",4:"mdi:tram",5:"mdi:bus",6:"mdi:bus-side",7:"mdi:bus-clock",8:"mdi:gondola",9:"mdi:ferry",10:"mdi:bus-multiple",11:"mdi:dots-horizontal"};function Je(e){return 0===e||1===e?"#455a64":2===e?"#1565c0":5===e||6===e||7===e?"#6a1b9a":null}let Xe=class extends se{constructor(){super(...arguments),this._versionMismatch=null,this._versionCheckDone=!1}static getConfigElement(){return document.createElement("linz-linien-austria-card-editor")}static getStubConfig(e){const t={show_hero:!0};if(!e)return t;const i=Object.keys(e.states).find(t=>{if(!t.startsWith("sensor."))return!1;const i=e.states[t]?.attributes;return void 0!==i&&"string"==typeof i.stop_id&&Array.isArray(i.departures)});return i&&(t.entity=i),t}setConfig(e){if(!e||"object"!=typeof e)throw new Error("Invalid configuration / Ungültige Konfiguration");this.config={show_hero:!0,...e}}_t(e,t){return Be(e,{configLanguage:this.config?.language,hassLanguage:this.hass?.language},t)}shouldUpdate(e){if(!this.config)return!1;if(e.has("config"))return!0;const t=e.get("hass");return!t||!!this.config.entity&&t.states[this.config.entity]!==this.hass.states[this.config.entity]}getCardSize(){return 6}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:4}}render(){!this._versionCheckDone&&this.hass&&(this._versionCheckDone=!0,async function(e){if(!e?.callWS)return null;try{const t=await e.callWS({type:"linz_linien_austria/card_version"});if(t?.version&&t.version!==Ee)return t.version}catch{}return null}(this.hass).then(e=>{e&&(this._versionMismatch=e)}));const e={configLanguage:this.config?.language,hassLanguage:this.hass?.language};if(!this.hass)return D`<ha-card><div class="card-content">…</div></ha-card>`;if(!this.config.entity)return D`<ha-card>
        ${De(this._versionMismatch,e)}
      ...
      </ha-card>`;const i=this.config.name||t.attributes.stop_name||t.attributes.friendly_name||"",n=t.attributes.stop_name||i,r=n?encodeURIComponent(/Linz/i.test(n)?n:`${n}, Linz`):"",a=r?`https://www.google.com/maps/search/?api=1&query=${r}`:null,o=this._t("card.open_in_maps"),s=t.attributes.departures??[],l=new Set((this.config.lines??[]).map(e=>e.trim()).filter(Boolean)),c=this.config.walk_times??{},h=s.filter(e=>{if(l.size>0&&!l.has(e.line))return!1;const t=c[e.line];if("number"==typeof t&&t>0){const i=this._countdownFor(e);if(null===i||i<t)return!1}return!0}),d="number"==typeof this.config.max_departures?Math.max(0,this.config.max_departures):h.length,p=this._computeHeroGroup(h),u=p[0],m=!1!==this.config.show_hero?new Set(p):new Set,g=h.filter(e=>!m.has(e)),f=0===d?[]:g.slice(0,d),_=void 0!==u?.mot?Ye[u.mot]??"mdi:tram":"mdi:tram",v=this._userLineColor(u?.line)??Je(u?.mot),b=v?`--header-color: ${v};`:"",w=new Set(h.map(e=>e.line).filter(Boolean)),y=(t.attributes.alerts??[]).filter(e=>{const t=e.affected_lines||[];return 0===t.length||t.some(e=>w.has(e))}),x=u?.direction||"",$=this.config.show_platform?this._platformText(u):"",A=$?`${x} · ${this._platformLabel(u,!0)} ${$}`:x,k=!1!==this.config.pulse_live,z=!!this.config.enable_animations;return D`
      <ha-card
      ...
      >
        ...
        ${0===d||0===f.length&&m.size>0?K:D`<ul class="departures" role="list">
                ${0===f.length?D`<li class="empty">
                      ${l.size>0&&s.length>0?this._t("card.no_matches_for_filter"):this._t("card.no_departures")}
                    </li>`:Le(f,e=>this._depKey(e),e=>this._renderRow(e))}
              </ul>`}
        <div class="foot">
    ...
    `}_computeHeroGroup(e){if(0===e.length)return[];const t=e.filter(e=>!e.is_cancelled);if(0===t.length){const t=e[0];return t?[t]:[]}const i=e=>"number"==typeof e.countdown_rt?e.countdown_rt:"number"==typeof e.countdown?e.countdown:Number.POSITIVE_INFINITY;let n=Number.POSITIVE_INFINITY;for(const e of t){const t=i(e);t<n&&(n=t)}if(!Number.isFinite(n)){const e=t[0];return e?[e]:[]}return n<=0?t.filter(e=>i(e)<=0):t.filter(e=>i(e)===n)}_renderHero(e){const t=e[0],i=this._countdownFor(t),n=t.is_cancelled?this._t("card.cancelled"):null===i?"—":i<=0?this._t("card.now"):`${i}`,r=e.map(e=>`${e.mot_name?`${e.mot_name} `:""}${e.line} ${e.direction}`),a=t.is_cancelled?this._t("card.cancelled"):null===i?this._t("card.unknown"):i<=0?this._t("card.now"):`${i} ${this._t("card.minutes")}`,o=` ${this._t("card.and_separator")} `,s=`${this._t("card.next_departure_label")}: ${r.join(o)}, ${a}${t.is_realtime&&!t.is_cancelled?`, ${this._t("card.realtime")}`:""}`,l=this._userLineColor(t.line)??Je(t.mot),c=l?`--hero-color: ${l};`:"";return D`
      ...
      >
        ...
        <div class="hero-meta">
          ${Le(e,e=>this._depKey(e),e=>this._renderHeroEntry(e))}
        </div>
      </section>
      ...
      >
        ...
        <span class="row-tail">
          ${this.config.show_platform&&!e.is_cancelled&&this._platformText(e)?D`<span
              ...
              >`:K}
          <span
            class=${ve({"row-time":!0,late:i&&!e.is_cancelled,early:n&&!e.is_cancelled,now:null!==t&&t<=0&&!e.is_cancelled})}
          >
            ${e.is_cancelled?this._t("card.cancelled"):r}
          </span>
        </span>
      </li>
    `}_renderLineBadge(e){const t=Ye[e.mot??-1]??"mdi:bus",i=this._userLineColor(e.line),n=i?`background: ${i};`:"";return D`
      <span
        class="line-badge"
        data-mot=${e.mot??""}
        style=${n}
    ...
    `}_userLineColor(e){if(!e)return null;const t=this.config.line_colors??{};return t[e]??t[e.toUpperCase()]??null}_depKey(e){return[e.line??"",e.direction??"",e.platform??"",e.scheduled??""].join("|")}_platformText(e){if(!e)return"";const t=(e.platform??"").trim();return t&&"0"!==t?t:""}_isRailMot(e){return 0===e||1===e}_platformLabel(e,t){const i=this._isRailMot(e?.mot)?t?"card.platform_rail_short":"card.platform_rail":t?"card.platform_short":"card.platform";return this._t(i)}_countdownFor(e){return"number"==typeof e.countdown_rt?e.countdown_rt:"number"==typeof e.countdown?e.countdown:null}static{this.styles=We}};e([pe({attribute:!1})],Xe.prototype,"hass",void 0),e([ue()],Xe.prototype,"config",void 0),e([ue()],Xe.prototype,"_versionMismatch",void 0),Xe=e([ce("linz-linien-austria-card")],Xe);export{Xe as LinzLinienAustriaCard};
