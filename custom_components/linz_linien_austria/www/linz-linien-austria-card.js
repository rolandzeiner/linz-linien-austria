...
`;function Je(e,t,i){e.dispatchEvent(new CustomEvent(t,{detail:i,bubbles:!0,composed:!0}))}let Xe=class extends se{constructor(){super(...arguments),this._config={type:"linz-linien-austria-card"},this._computeLabel=e=>{const t=`ui.panel.lovelace.editor.card.generic.${e.name}`,i=this.hass?.localize?.(t);if(i)return i;const r=`editor.${e.name}`,n=Be(r,{hassLanguage:this.hass?.language});return n!==r?n:e.name},this._computeHelper=e=>{const t=`editor.${e.name}_helper`,i=Be(t,{hassLanguage:this.hass?.language});return i===t?void 0:i},this._onFormChanged=e=>{const t={...e.detail.value};this._config=t,Je(this,"config-changed",{config:t})},this._onWalkTimeChange=(e,t)=>{const i=t.target.value.trim();if(""===i)return void this._patchRecord("walk_times",e,void 0);const r=Number(i);!Number.isFinite(r)||r<=0?this._patchRecord("walk_times",e,void 0):this._patchRecord("walk_times",e,Math.round(r))},this._onLineColorChange=(e,t)=>{const i=t.target;this._patchRecord("line_colors",e,i.value)},this._onLineColorClear=e=>{this._patchRecord("line_colors",e,void 0)}}setConfig(e){this._config={...e}}_t(e,t){return Be(e,{hassLanguage:this.hass?.language},t)}_allKnownLines(){const e=new Set,t=this._config.entity;if(t&&this.hass){const i=this.hass.states[t],r=i?.attributes?.lines_at_stop;if(Array.isArray(r))for(const t of r)"string"==typeof t&&t&&e.add(t);const n=i?.attributes?.departures;if(Array.isArray(n))for(const t of n)t.line&&e.add(t.line)}for(const t of this._config.lines??[])t&&e.add(t);return this._sortLines(Array.from(e))}_availableLines(){const e=(this._config.lines??[]).map(e=>e.trim()).filter(Boolean);return e.length>0?this._sortLines(e):this._allKnownLines()}_sortLines(e){return Array.from(new Set(e)).sort((e,t)=>{const i=parseInt(e,10),r=parseInt(t,10);return Number.isNaN(i)||Number.isNaN(r)||i===r?e.localeCompare(t,void 0,{numeric:!0}):i-r})}_motForLine(e){const t=this._config.entity;if(!t||!this.hass)return;const i=this.hass.states[t],r=i?.attributes?.departures;if(Array.isArray(r))for(const t of r)if(t.line===e&&"number"==typeof t.mot)return t.mot}_defaultColorForLine(e){return Ge(this._motForLine(e))??"#f08000"}_iconForLine(e){return Ve(this._motForLine(e))}_toggleLine(e){const t=new Set(this._config.lines??[]);t.has(e)?t.delete(e):t.add(e);const i={...this._config};0===t.size?delete i.lines:i.lines=this._sortLines(Array.from(t)),this._config=i,Je(this,"config-changed",{config:i})}_onCustomLineSubmit(e){const t=e.value.trim();if(!t)return;const i=new Set(this._config.lines??[]);i.add(t);const r={...this._config,lines:this._sortLines(Array.from(i))};e.value="",this._config=r,Je(this,"config-changed",{config:r})}_renderLinesFilter(){const e=this._allKnownLines(),t=new Set(this._config.lines??[]);return B`
      <div class="editor-section">
        ...
        ${0===e.length?B`<div class="editor-hint">
              ...
              ${e.map(e=>{const i=this._defaultColorForLine(e),r=this._iconForLine(e),n=t.has(e);return B`
                  <button
                    type="button"
    ...
    `}_schema(){return[{name:"entity",required:!0,selector:{entity:{domain:"sensor",integration:"linz_linien_austria"}}},{name:"name",selector:{text:{}}},{name:"hide_header",selector:{boolean:{}}},{name:"show_hero",selector:{boolean:{}}},{name:"show_platform",selector:{boolean:{}}},{name:"show_alerts",selector:{boolean:{}}},{name:"pulse_live",selector:{boolean:{}}},{name:"enable_animations",selector:{boolean:{}}},{name:"max_departures",selector:{number:{min:0,max:30,step:1,mode:"box"}}}]}_patchRecord(e,t,i){const r={...this._config[e]??{}};null==i||""===i?delete r[t]:r[t]=i;const n={...this._config};0===Object.keys(r).length?delete n[e]:n[e]=r,this._config=n,Je(this,"config-changed",{config:n})}_renderPerLineSection(){const e=this._availableLines();if(0===e.length)return B`<div class="editor-hint">
      ...
      <div class="editor-section">
        ...
        <div class="per-line-list">
          ${e.map(e=>{const r=t[e],n=i[e]??"",o=this._defaultColorForLine(e),a=n||o;return B`
    ...
    `}static{this.styles=Ye}};e([pe({attribute:!1})],Xe.prototype,"hass",void 0),e([ue()],Xe.prototype,"_config",void 0),Xe=e([ce("linz-linien-austria-card-editor")],Xe),window.customCards=window.customCards||[],window.customCards.push({type:"linz-linien-austria-card",name:"Linz Linien Austria",description:"Live LINZ AG LINIEN departure monitor.",preview:!0,documentationURL:"https://github.com/rolandzeiner/linz-linien-austria",getEntitySuggestion:(e,t)=>t.startsWith("sensor.")?"linz_linien_austria"!==e?.entities?.[t]?.platform?null:{config:{type:"custom:linz-linien-austria-card",entity:t,show_hero:!0}}:null});let Qe=class extends se{constructor(){super(...arguments),this._versionMismatch=null,this._versionCheckDone=!1,this._expandedStops=new Set}static getConfigElement(){return document.createElement("linz-linien-austria-card-editor")}static getStubConfig(e){const t={show_hero:!0};if(!e)return t;const i=Object.keys(e.states).find(t=>{if(!t.startsWith("sensor."))return!1;const i=e.states[t]?.attributes;return void 0!==i&&"string"==typeof i.stop_id&&Array.isArray(i.departures)});return i&&(t.entity=i),t}setConfig(e){if(!e||"object"!=typeof e)throw new Error("Invalid configuration / Ungültige Konfiguration");this.config={show_hero:!0,...e}}_t(e,t){return Be(e,{configLanguage:this.config?.language,hassLanguage:this.hass?.language},t)}shouldUpdate(e){if(!this.config)return!1;if(e.has("config"))return!0;const t=e.get("hass");return!t||!!this.config.entity&&t.states[this.config.entity]!==this.hass.states[this.config.entity]}getCardSize(){return 6}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:4}}firstUpdated(){this._maybeRunVersionCheck()}updated(e){this._maybeRunVersionCheck()}_maybeRunVersionCheck(){!this._versionCheckDone&&this.hass&&(this._versionCheckDone=!0,async function(e){if(!e?.callWS)return null;try{const t=await e.callWS({type:"linz_linien_austria/card_version"});if(t?.version&&"0.7.2"!==t.version)return t.version}catch{}return null}(this.hass).then(e=>{e&&this.isConnected&&(this._versionMismatch=e)}))}render(){const e={configLanguage:this.config?.language,hassLanguage:this.hass?.language};if(!this.hass)return B`<ha-card><div class="card-content">…</div></ha-card>`;if(!this.config.entity)return B`<ha-card>
      ...
      >
        ...
        ${0===m||0===w.length&&_.size>0?K:B`<ul class="departures" role="list">
                ${0===w.length?B`<li class="empty">
    ...
    `}_renderHeroStops(e){const t=e.is_cancelled?[]:e.stops_ahead??[];if(0===t.length)return K;const i=this._depKey(e),r=this._expandedStops.has(i),n=`hero-stops-${this._slugify(i)}`,o=`${e.mot_name?`${e.mot_name} `:""}${e.line} ${e.direction}`;return B`
    ...
    `}_renderRow(e){const t=this._countdownFor(e),i="number"==typeof e.delay_minutes&&e.delay_minutes>0,r="number"==typeof e.delay_minutes&&e.delay_minutes<0,n=null===t?"—":t<=0?this._t("card.now"):`${t} ${this._t("card.minutes_short")}`,o=e.is_cancelled?"":(e.delay_hint??"").trim(),a=e.is_cancelled?[]:e.stops_ahead??[],s=this._depKey(e),l=this._expandedStops.has(s),c=`stops-${this._slugify(s)}`,d=a.length>0,h=`${e.mot_name?`${e.mot_name} `:""}${e.line} ${e.direction} ${e.is_cancelled?this._t("card.cancelled"):n}${e.is_realtime?` ${this._t("card.realtime")}`:""}${o?`. ${o}`:""}`,p=d?`${h}. ${this._t(l?"card.hide_stops":"card.show_stops",{line:e.line,direction:e.direction})}`:h,u=B`
      ...
      >
        ...
        <span class="row-main">
          ...
          ${o?B`<span class="row-hint" title=${o}>${o}</span>`:K}
        </span>
        <span class="row-tail">
    ...
    `;return 0===a.length?u:[u,this._renderStopsAheadPanel(a,c,l,e)]}_onExpanderKeydown(e,t,i){t&&("Enter"!==e.key&&" "!==e.key||(e.preventDefault(),i()))}_toggleStops(e){const t=new Set(this._expandedStops);t.delete(e)||t.add(e),this._expandedStops=t}_slugify(e){return e.replace(/[^a-zA-Z0-9_-]+/g,"-")}_renderStopsAheadPanel(e,t,i,r){const n=`${r.mot_name?`${r.mot_name} `:""}${r.line} ${r.direction}`;return B`
    ...
    `}_renderStopsAheadTrail(e,t){const i=this._userLineColor(t.line)??Ge(t.mot)??"var(--linz-accent)";return B`
      ...
      >
        ${e.map((t,i)=>{const r=t.delay_minutes,n=i===e.length-1;return B`<li
    ...
    `}_clockTime(e){return!e||e.length<16?"":e.slice(11,16)}_renderLineBadge(e){const t=Ve(e.mot,"mdi:bus"),i=this._userLineColor(e.line),r=i?`background: ${i};`:"";return B`
      <span
        class="line-badge"
        data-mot=${e.mot??""}
        style=${r}
