...
`;function Z(e,t,n){e.dispatchEvent(new CustomEvent(t,{detail:n,bubbles:!0,composed:!0}))}function Q(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}let xt=class extends V{constructor(...e){super(...e),this._config={type:`linz-linien-austria-card`},this._computeLabel=e=>{let t=`ui.panel.lovelace.editor.card.generic.${e.name}`,n=this.hass?.localize?.(t);if(n)return n;let r=`editor.${e.name}`,i=K(r,{hassLanguage:this.hass?.language});return i===r?e.name:i},this._computeHelper=e=>{let t=`editor.${e.name}_helper`,n=K(t,{hassLanguage:this.hass?.language});return n===t?void 0:n},this._onFormChanged=e=>{let t={...e.detail.value};this._config=t,Z(this,`config-changed`,{config:t})},this._onWalkTimeChange=(e,t)=>{let n=t.target.value.trim();if(n===``){this._patchRecord(`walk_times`,e,void 0);return}let r=Number(n);if(!Number.isFinite(r)||r<=0){this._patchRecord(`walk_times`,e,void 0);return}this._patchRecord(`walk_times`,e,Math.round(r))},this._onLineColorChange=(e,t)=>{let n=t.target;this._patchRecord(`line_colors`,e,n.value)},this._onLineColorClear=e=>{this._patchRecord(`line_colors`,e,void 0)}}setConfig(e){this._config={...e}}_t(e,t){return K(e,{hassLanguage:this.hass?.language},t)}_allKnownLines(){let e=new Set,t=this._config.entity;if(t&&this.hass){let n=this.hass.states[t],r=n?.attributes?.lines_at_stop;if(Array.isArray(r))for(let t of r)typeof t==`string`&&t&&e.add(t);let i=n?.attributes?.departures;if(Array.isArray(i))for(let t of i)t.line&&e.add(t.line)}for(let t of this._config.lines??[])t&&e.add(t);return this._sortLines(Array.from(e))}_availableLines(){let e=(this._config.lines??[]).map(e=>e.trim()).filter(Boolean);return e.length>0?this._sortLines(e):this._allKnownLines()}_lineDestinations(){let e=new Map,t=this._config.entity,n=t?this.hass?.states[t]?.attributes?.departures:void 0;if(!Array.isArray(n))return e;for(let t of n){let n=t.dir_code;if(n!==`H`&&n!==`R`)continue;let r=(t.direction??``).trim();if(!r||!t.line)continue;let i=e.get(t.line)??{};i[n]===void 0&&(i[n]=r,e.set(t.line,i))}return e}_onLineDirectionChange(e,t){let n={...this._config.line_directions??{}};t===null?delete n[e]:n[e]=t;let r={...this._config};Object.keys(n).length>0?r.line_directions=n:delete r.line_directions,this._config=r,Z(this,`config-changed`,{config:r})}_sortLines(e){return Array.from(new Set(e)).sort((e,t)=>{let n=parseInt(e,10),r=parseInt(t,10);return!Number.isNaN(n)&&!Number.isNaN(r)&&n!==r?n-r:e.localeCompare(t,void 0,{numeric:!0})})}_motForLine(e){let t=this._config.entity;if(!t||!this.hass)return;let n=this.hass.states[t]?.attributes?.departures;if(Array.isArray(n)){for(let t of n)if(t.line===e&&typeof t.mot==`number`)return t.mot}}_defaultColorForLine(e){return J(this._motForLine(e))}_iconForLine(e){return st(this._motForLine(e))}_toggleLine(e){let t=new Set(this._config.lines??[]);t.has(e)?t.delete(e):t.add(e);let n={...this._config};t.size===0?delete n.lines:n.lines=this._sortLines(Array.from(t)),this._config=n,Z(this,`config-changed`,{config:n})}_onCustomLineSubmit(e){let t=e.value.trim();if(!t)return;let n=new Set(this._config.lines??[]);n.add(t);let r={...this._config,lines:this._sortLines(Array.from(n))};e.value=``,this._config=r,Z(this,`config-changed`,{config:r})}_renderLinesFilter(){let e=this._allKnownLines(),t=new Set(this._config.lines??[]);return P`
    ...
    `}_schema(){return[{name:`entity`,required:!0,selector:{entity:{filter:{domain:`sensor`,integration:`linz_linien_austria`}}}},{name:`name`,selector:{text:{}}},{name:`hide_header`,selector:{boolean:{}}},{name:`show_hero`,selector:{boolean:{}}},{name:`show_platform`,selector:{boolean:{}}},{name:`show_absolute_time`,selector:{boolean:{}}},{name:`show_alerts`,selector:{boolean:{}}},{name:`pulse_live`,selector:{boolean:{}}},{name:`enable_animations`,selector:{boolean:{}}},{name:`max_departures`,selector:{number:{min:0,max:30,step:1,mode:`box`}}}]}_patchRecord(e,t,n){let r={...this._config[e]??{}};n==null||n===``?delete r[t]:r[t]=n;let i={...this._config};Object.keys(r).length===0?delete i[e]:i[e]=r,this._config=i,Z(this,`config-changed`,{config:i})}_renderPerLineSection(){let e=this._availableLines();if(e.length===0)return P`<div class="editor-hint">
        ${this._t(`editor.per_line_no_data`)}
      </div>`;let t=this._config.walk_times??{},n=this._config.line_colors??{},r=this._config.line_directions??{},i=this._lineDestinations();return P`
      <div class="editor-section">
        ...
        <div class="per-line-list">
          ${e.map(e=>{let a=t[e],o=n[e]??``,s=this._defaultColorForLine(e),c=o||s,l=r[e],u=i.get(e)??{},d=(t,n)=>{let r=this._t(t===`H`?`editor.direction_h`:t===`R`?`editor.direction_r`:`editor.direction_both`),i=t?u[t]:void 0,a=i?`${r} → ${i}`:r,o=(l??null)===t;return P`<button
                type="button"
    ...
    `}static{this.styles=bt}};Q([Ae({attribute:!1})],xt.prototype,`hass`,void 0),Q([H()],xt.prototype,`_config`,void 0),xt=Q([De(`linz-linien-austria-card-editor`)],xt),window.customCards=window.customCards||[],window.customCards.push({type:`linz-linien-austria-card`,name:`Linz Linien Austria`,description:`Live LINZ AG LINIEN departure monitor.`,preview:!0,documentationURL:`https://github.com/rolandzeiner/linz-linien-austria`,getEntitySuggestion:(e,t)=>!t.startsWith(`sensor.`)||e?.entities?.[t]?.platform!==`linz_linien_austria`?null:{config:{type:`custom:linz-linien-austria-card`,entity:t,show_hero:!0}}});let $=class extends V{constructor(...e){super(...e),this._versionMismatch=null,this._versionCheckDone=!1,this._expandedStops=new Set}static getConfigElement(){return document.createElement(`linz-linien-austria-card-editor`)}static getStubConfig(e){let t={show_hero:!0};if(!e)return t;let n=Object.keys(e.states).find(t=>{if(!t.startsWith(`sensor.`))return!1;let n=e.states[t]?.attributes;return n!==void 0&&typeof n.stop_id==`string`&&Array.isArray(n.departures)});return n&&(t.entity=n),t}setConfig(e){if(!e||typeof e!=`object`)throw Error(`Invalid configuration / Ungültige Konfiguration`);this.config={show_hero:!0,...e}}_t(e,t){return K(e,{configLanguage:this.config?.language,hassLanguage:this.hass?.language},t)}shouldUpdate(e){if(!this.config)return!1;if(e.has(`config`))return!0;let t=e.get(`hass`);return t?this.config.entity?t.states[this.config.entity]!==this.hass.states[this.config.entity]:!1:!0}getCardSize(){return 6}getGridOptions(){return{columns:12,rows:`auto`,min_columns:6,min_rows:4}}firstUpdated(){this._maybeRunVersionCheck()}updated(e){this._maybeRunVersionCheck()}_maybeRunVersionCheck(){!this._versionCheckDone&&this.hass&&(this._versionCheckDone=!0,ht(this.hass).then(e=>{e&&this.isConnected&&(this._versionMismatch=e)}))}render(){let e={configLanguage:this.config?.language,hassLanguage:this.hass?.language};if(!this.hass)return P`<ha-card><div class="card-content">…</div></ha-card>`;if(!this.config.entity)return P`<ha-card>
      ...
      </ha-card>`;let n=this.config.name||t.attributes.stop_name||t.attributes.friendly_name||``,r=t.attributes.latitude,i=t.attributes.longitude,a=t.attributes.stop_name||n,o=typeof r==`number`&&typeof i==`number`?`${r},${i}`:a?encodeURIComponent(/Linz/i.test(a)?a:`${a}, Linz`):``,s=o?mt(`https://www.google.com/maps/search/?api=1&query=${o}`):null,c=this._t(`card.open_in_maps`),l=t.attributes.departures??[],u=new Set((this.config.lines??[]).map(e=>e.trim()).filter(Boolean)),d=this.config.line_directions,f=new Map;if(d&&typeof d==`object`)for(let[e,t]of Object.entries(d)){let n=typeof t==`string`?t.trim().toUpperCase():``;(n===`H`||n===`R`)&&f.set(e.trim(),n)}let p=this.config.walk_times??{},m=l.filter(e=>{if(u.size>0&&!u.has(e.line))return!1;let t=f.get(e.line);if(t&&e.dir_code&&e.dir_code!==t)return!1;let n=p[e.line];if(typeof n==`number`&&n>0){let t=this._countdownFor(e);if(t===null||t<n)return!1}return!0}),h=typeof this.config.max_departures==`number`?Math.max(0,this.config.max_departures):m.length,g=this._computeHeroGroup(m),_=g[0],ee=this.config.show_hero===!1?new Set:new Set(g),te=m.filter(e=>!ee.has(e)),v=h===0?[]:te.slice(0,h),y=st(_?.mot),b=this._userLineColor(_?.line)??q(_?.mot),x=this._accentText(this._userLineColor(_?.line)??J(_?.mot)),ne=(b?`--header-color: ${b};`:``)+(x?`--header-text: ${x};`:``),S=new Set(m.map(e=>e.line).filter(Boolean)),C=(t.attributes.alerts??[]).filter(e=>{let t=e.affected_lines||[];return t.length===0||t.some(e=>S.has(e))}),w=_?.direction||``,T=this.config.show_platform?this._platformText(_):``,E=T?`${w} · ${this._platformLabel(_,!0)} ${T}`:w,D=this.config.pulse_live!==!1,O=!!this.config.enable_animations;return P`
      <ha-card
        class=${U({"no-pulse":!D,"with-animations":O})}
      >
        ${vt(this._versionMismatch,e)}
        ${this.config.hide_header?I:P`<header class="head" style=${ne}>
              <span class="icon-tile" aria-hidden="true">
                <ha-icon icon=${y}></ha-icon>
              </span>
              <div class="title-block">
                <h3 class="title">${n}</h3>
                ${E?P`<p class="subtitle">${E}</p>`:I}
              </div>
        ...
        ${this.config.show_alerts!==!1&&C.length>0?this._renderAlerts(C):I}
        ${this.config.show_hero&&g.length>0?this._renderHero(g):I}
        ${h===0||v.length===0&&ee.size>0?I:P`<ul class="departures" role="list">
                ${v.length===0?P`<li class="empty">
                      ${(u.size>0||f.size>0)&&l.length>0?this._t(`card.no_matches_for_filter`):this._t(`card.no_departures`)}
                    </li>`:He(v,e=>this._depKey(e),e=>this._renderRow(e))}
              </ul>`}
        <div class="foot">
