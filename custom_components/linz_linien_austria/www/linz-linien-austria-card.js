...
* Copyright 2017 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
*/function H(e){return Ae({...e,state:!0,attribute:!1})}
/**
* @license
* Copyright 2017 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
...
* SPDX-License-Identifier: BSD-3-Clause
*/const U=Me(class extends Ne{constructor(e){if(super(e),e.type!==je.ATTRIBUTE||e.name!==`class`||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return` `+Object.keys(e).filter(t=>e[t]).join(` `)+` `}update(e,[t]){if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(` `).split(/\s/).filter(e=>e!==``)));for(let e in t)t[e]&&!this.nt?.has(e)&&this.st.add(e);return this.render(t)}let n=e.element.classList;for(let e of this.st)e in t||(n.remove(e),this.st.delete(e));for(let e in t){let r=!!t[e];r===this.st.has(e)||this.nt?.has(e)||(r?(n.add(e),this.st.add(e)):(n.remove(e),this.st.delete(e)))}return F}}),{I:Pe}=Se,Fe=e=>e,Ie=()=>document.createComment(``),W=(e,t,n)=>{
/**
* @license
* Copyright 2020 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
*/
let r=e._$AA.parentNode,i=t===void 0?e._$AB:t._$AA;if(n===void 0){let t=r.insertBefore(Ie(),i),a=r.insertBefore(Ie(),i);n=new Pe(t,a,e,e.options)}else{let t=n._$AB.nextSibling,a=n._$AM,o=a!==e;if(o){let t;n._$AQ?.(e),n._$AM=e,n._$AP!==void 0&&(t=e._$AU)!==a._$AU&&n._$AP(t)}if(t!==i||o){let e=n._$AA;for(;e!==t;){let t=Fe(e).nextSibling;Fe(r).insertBefore(e,i),e=t}}}return n},G=(e,t,n=e)=>(e._$AI(t,n),e),Le={},Re=(e,t=Le)=>e._$AH=t,ze=e=>e._$AH,Be=e=>{e._$AR(),e._$AA.remove()},Ve=(e,t,n)=>{
/**
* @license
* Copyright 2017 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
*/
let r=new Map;for(let i=t;i<=n;i++)r.set(e[i],i);return r},He=Me(class extends Ne{constructor(e){if(super(e),e.type!==je.CHILD)throw Error(`repeat() can only be used in text expressions`)}dt(e,t,n){let r;n===void 0?n=t:t!==void 0&&(r=t);let i=[],a=[],o=0;for(let t of e)i[o]=r?r(t,o):o,a[o]=n(t,o),o++;return{values:a,keys:i}}render(e,t,n){return this.dt(e,t,n).values}update(e,[t,n,r]){let i=ze(e),{values:a,keys:o}=this.dt(t,n,r);if(!Array.isArray(i))return this.ut=o,a;let s=this.ut??=[],c=[],l,u,d=0,f=i.length-1,p=0,m=a.length-1;for(;d<=f&&p<=m;)if(i[d]===null)d++;else if(i[f]===null)f--;else if(s[d]===o[p])c[p]=G(i[d],a[p]),d++,p++;else if(s[f]===o[m])c[m]=G(i[f],a[m]),f--,m--;else if(s[d]===o[m])c[m]=G(i[d],a[m]),W(e,c[m+1],i[d]),d++,m--;else if(s[f]===o[p])c[p]=G(i[f],a[p]),W(e,i[d],i[f]),f--,p++;else if(l===void 0&&(l=Ve(o,p,m),u=Ve(s,d,f)),l.has(s[d])){if(l.has(s[f])){let t=u.get(o[p]),n=t===void 0?null:i[t];if(n===null){let t=W(e,i[d]);G(t,a[p]),c[p]=t}else c[p]=G(n,a[p]),W(e,i[d],n),i[t]=null;p++}else Be(i[f]),f--}else Be(i[d]),d++;for(;p<=m;){let t=W(e,c[m+1]);G(t,a[p]),c[p++]=t}for(;d<=f;){let e=i[d++];e!==null&&Be(e)}return this.ut=o,Re(e,c),F}}),Ue=Me(class extends Ne{constructor(e){
/**
* @license
* Copyright 2018 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
*/
if(super(e),e.type!==je.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(` !important`);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?`important`:``):n[e]=r}}return F}});var We=t({card:()=>Ke,common:()=>Ge,default:()=>Je,editor:()=>qe}),Ge={no_entity_picked:`Keine Entität ausgewählt. Visuellen Editor öffnen und einen Linz Linien Sensor wählen.`,entity_unavailable:`Die ausgewählte Entität ist derzeit nicht verfügbar.`,version_update:`Eine neuere Kartenversion ({v}) ist verfügbar. Bitte neu laden.`,version_reload:`Jetzt neu laden`,version_reload_stuck:`Neu laden hat die neue Version nicht übernommen. Schließen Sie diesen Browser-Tab und öffnen Sie das Dashboard erneut, oder löschen Sie die Website-Daten für Home Assistant in den Browser-Einstellungen.`},Ke={no_departures:`Keine kommenden Abfahrten.`,no_matches_for_filter:`Keine kommenden Abfahrten passen zum Filter.`,platform:`Steig`,platform_short:`Steig`,platform_rail:`Gleis`,platform_rail_short:`Gleis`,open_in_maps:`In Google Maps öffnen`,next_departure_label:`Nächste Abfahrt`,and_separator:`und`,minutes:`Minuten`,minutes_short:`Min`,now:`Jetzt`,unknown:`—`,realtime:`Live`,at_time:`um {time}`,cancelled:`Entfällt`,alerts_summary:`{count} Verkehrshinweis(e)`,affected_lines:`Betroffene Linien`,attribution:`Datenquelle: LINZ AG LINIEN (data.linz.gv.at) · CC BY 4.0`,show_stops:`Folgehaltestellen der Linie {line} Richtung {direction} anzeigen`,hide_stops:`Folgehaltestellen der Linie {line} Richtung {direction} ausblenden`},qe={entity:`Sensor`,entity_helper:`Einen sensor.*_next_departure Sensor dieser Integration wählen.`,entity_missing:`Sensor {entity} existiert nicht mehr. Wählen Sie oben einen anderen Sensor.`,name:`Titel`,name_helper:`Optionaler Überschreib-Titel für die Karte.`,hide_header:`Kopfzeile ausblenden`,hide_header_helper:`Blendet das Symbol, den Haltestellennamen, die Untertitelzeile und den Karten-Link aus. Hero und Abfahrtsliste bleiben sichtbar.`,show_hero:`Hauptbereich anzeigen`,show_hero_helper:`Großer Countdown zur nächsten Abfahrt.`,max_departures:`Max. Abfahrten`,max_departures_helper:`Begrenzt die Liste. Karten-Filter (Linien + Richtung + Fußweg) entfernen Zeilen VOR diesem Limit — 10 hier bedeutet also nicht zwingend 10 sichtbare Zeilen. Falls weniger als erwartet erscheinen, in der Integration die ‚Anzahl der Abfahrten' erhöhen (Einstellungen → Geräte & Dienste → Linz Linien Austria → Konfigurieren) — das ist der Pool, aus dem die Karte filtert. 0 zeigt nur den Nächste-Abfahrt-Block ohne Zeilen.`,lines:`Linien filtern`,lines_helper:`Leer (keine Chips ausgewählt) = alle Linien anzeigen. Chips antippen, um Linien ein- oder auszuschließen. Bei engem Filter an stark frequentierten Haltestellen (Hauptbahnhof) ggf. in der Integration die ‚Anzahl der Abfahrten' erhöhen, damit die Karte genügend Zeilen zum Filtern hat.`,lines_custom_placeholder:`Linie hinzufügen, die oben nicht angezeigt wird (Enter)`,show_platform:`Steig anzeigen`,show_platform_helper:`Steig in der Untertitelzeile (nächste Abfahrt) und am Ende jeder Zeile einblenden.`,show_absolute_time:`Abfahrtszeit anzeigen`,show_absolute_time_helper:`Zeigt zusätzlich zur Restzeit die tatsächliche Abfahrtszeit an („4 Min · 15:44“). Bei Echtzeitdaten ist das die prognostizierte, sonst die planmäßige Zeit, damit Uhrzeit und Countdown daneben dieselbe Fahrt beschreiben.`,directions:`Richtung filtern`,directions_helper:`Nichts ausgewählt = beide Richtungen anzeigen. Gefiltert wird über den stabilen Richtungscode der Linie, nicht über den Zieltext — damit verschwinden auch kurzgeführte Fahrten nicht, die dasselbe Ziel bedienen. Fahrten ohne Richtungscode (z. B. Schienenersatzverkehr) werden immer angezeigt.`,direction_h:`Hinfahrt`,direction_r:`Rückfahrt`,show_alerts:`Verkehrsinfo anzeigen`,show_alerts_helper:`Aufklappbares Verkehrsinfo-Banner über der Abfahrtsliste anzeigen, wenn LINZ AG aktuelle Hinweise veröffentlicht.`,pulse_live:`Live-Indikator pulsiert`,pulse_live_helper:`Der grüne Punkt vor Echtzeit-Minutenangaben pulsiert dezent. Standard: an. Bei aktivierter Systemeinstellung "Bewegung reduzieren" erscheint der Punkt unabhängig von diesem Schalter statisch.`,enable_animations:`CSS-Animationen`,enable_animations_helper:`Sanftes Einblenden beim Laden der Karte plus weichere Farbübergänge (Linienbadge bei wechselndem Verkehrsmittel, Hero-Akzent, Hover-Tönung, Verkehrsinfo-Banner). Standard: aus, ruhiger statischer Look. Die Systemeinstellung "Bewegung reduzieren" hat weiterhin Vorrang.`,section_per_line:`Fußweg & Farbe pro Linie`,per_line_hint:`Fußweg: Abfahrten, deren Countdown unter dieser Minutenzahl liegt, werden ausgeblendet — sie sind ohnehin nicht erreichbar. Farbe: überschreibt die Linienbadge-Tönung. Bei längerem Fußweg gegebenenfalls in der Integration die ‚Anzahl der Abfahrten' erhöhen.`,per_line_no_data:`Oben einen Sensor wählen, dann erscheinen hier die Linien.`,walk_time:`Fußweg`,walk_time_placeholder:`Min`,minutes_short:`Min`,line_color:`Linienfarbe`,line_color_clear:`Standardfarbe wiederherstellen`},Je={common:Ge,card:Ke,editor:qe},Ye=t({card:()=>Ze,common:()=>Xe,default:()=>$e,editor:()=>Qe}),Xe={no_entity_picked:`No entity selected. Open the visual editor and pick a Linz Linien sensor.`,entity_unavailable:`The selected entity is not available right now.`,version_update:`A newer card version ({v}) is available. Reload to refresh.`,version_reload:`Reload now`,version_reload_stuck:`Reload didn't pick up the new version. Close this browser tab and reopen the dashboard, or clear your browser's site data for Home Assistant.`},Ze={no_departures:`No upcoming departures.`,no_matches_for_filter:`No upcoming departures match the filter.`,platform:`Platform`,platform_short:`Pl.`,platform_rail:`Track`,platform_rail_short:`Tr.`,open_in_maps:`Open in Google Maps`,next_departure_label:`Next departure`,and_separator:`and`,minutes:`minutes`,minutes_short:`min`,now:`Now`,unknown:`—`,realtime:`Live`,at_time:`at {time}`,cancelled:`Cancelled`,alerts_summary:`{count} service notice(s)`,affected_lines:`Affected lines`,attribution:`Source: LINZ AG LINIEN (data.linz.gv.at) · CC BY 4.0`,show_stops:`Show remaining stops for line {line} to {direction}`,hide_stops:`Hide remaining stops for line {line} to {direction}`},Qe={entity:`Sensor`,entity_helper:`Pick a sensor.*_next_departure produced by this integration.`,entity_missing:`Sensor {entity} no longer exists. Pick a different sensor in the entity selector above.`,name:`Title`,name_helper:`Optional override for the card heading.`,hide_header:`Hide header`,hide_header_helper:`Hides the icon tile, stop name, subtitle and maps link. Hero and departure list remain visible.`,show_hero:`Show hero block`,show_hero_helper:`Big countdown for the next departure.`,max_departures:`Max departures`,max_departures_helper:`Cap the rendered list. Card-side filters (lines, directions, walk time) trim rows BEFORE this cap, so setting it to 10 doesn't guarantee 10 rows. If you see fewer than expected, raise the integration's 'Departures to fetch' under Settings → Devices & Services → Linz Linien Austria → Configure — that's the pool the card filters from. Set 0 to render only the next-departure block above without any rows.`,lines:`Filter by lines`,lines_helper:`Empty (no chips selected) = show every line. Tap chips to toggle which lines to keep. Tight filters at busy stops (Hauptbahnhof) may need the integration's 'Departures to fetch' raised so the card has enough pre-filter rows to find matches.`,lines_custom_placeholder:`Add a line not shown above (press Enter)`,show_platform:`Show platform`,show_platform_helper:`Show the platform / bay (Steig) on the next-departure subtitle and at the trailing edge of each row.`,show_absolute_time:`Show departure time`,show_absolute_time_helper:`Adds the actual departure time next to the countdown ("4 min · 15:44"). Uses the realtime prediction where the operator publishes one and the scheduled time otherwise, so the clock and the countdown beside it describe the same trip.`,directions:`Filter direction`,directions_helper:`Nothing selected = show both directions. Filtering keys on the line's stable direction code rather than the headsign, so short-turning trips that still serve your direction are not dropped. Departures without a direction code (replacement services, for instance) always pass.`,direction_h:`Outbound`,direction_r:`Inbound`,show_alerts:`Show traffic info`,show_alerts_helper:`Show the collapsible traffic-info banner above the departure list when LINZ AG has active service notices.`,pulse_live:`Pulse live indicator`,pulse_live_helper:`Animate the green dot in front of realtime-corrected minute counts. Defaults on. Users with the OS prefers-reduced-motion preference get a static dot regardless of this toggle.`,enable_animations:`CSS animations`,enable_animations_helper:`Add a one-shot card-mount fade-in plus longer-duration colour transitions (line badge recolour as the next departure changes mode-of-transport, hero accent shift, row hover tint, alerts banner fade). Defaults off for a calm static look. Honoured prefers-reduced-motion still wins.`,section_per_line:`Per-line walk time & colour`,per_line_hint:"Walk time (Fußweg): drop a departure when its countdown is below this many minutes — you couldn't catch it anyway. Colour: override the line badge tint. Raise the integration's `Departures to fetch` if a long walk leaves too few rows visible.",per_line_no_data:`Pick an entity above to see its lines here.`,walk_time:`Walk time`,walk_time_placeholder:`min`,minutes_short:`min`,line_color:`Line colour`,line_color_clear:`Reset to default colour`},$e={common:Xe,card:Ze,editor:Qe};const et={de:We,en:Ye};function tt(e,t){return e.split(`.`).reduce((e,t)=>{if(e&&typeof e==`object`&&t in e)return e[t]},t)}function nt(e,t){let n=tt(e,t);return typeof n==`string`?n:void 0}function rt(e){return(e.configLanguage||e.hassLanguage||`en`).replace(`-`,`_`).split(`_`)[0]===`de`?`de`:`en`}const it=et.en??{};function K(e,t,n){let r=rt(t),i=nt(e,et[r]??it);if(i===void 0&&(i=nt(e,it)),i===void 0)return e;if(n)for(let[e,t]of Object.entries(n))i=i.replace(`{${e}}`,String(t));return i}const at={0:`mdi:train`,1:`mdi:train`,2:`mdi:subway-variant`,3:`mdi:tram`,4:`mdi:tram`,5:`mdi:bus`,6:`mdi:bus-side`,7:`mdi:bus-clock`,8:`mdi:gondola`,9:`mdi:ferry`,10:`mdi:bus-multiple`,11:`mdi:dots-horizontal`},ot={0:`#455a64`,1:`#455a64`,2:`#1565c0`,5:`#6a1b9a`,6:`#6a1b9a`,7:`#6a1b9a`};function st(e,t=`mdi:tram`){return e===void 0?t:at[e]??t}function q(e){return e===void 0?null:ot[e]??null}function J(e){return q(e)??`#f08000`}const Y=e=>Math.min(1,Math.max(0,e)),X=e=>e<=.04045?e/12.92:((e+.055)/1.055)**2.4,ct=e=>e<=.0031308?e*12.92:1.055*e**(1/2.4)-.055;function lt(e){let t=e.trim();if(!t||t.includes(`var(`))return null;let n=/^#[0-9a-f]{3,8}$/i.test(t)?t.slice(1):``;if(!n){let e=``;try{let n=document.createElement(`span`).style;n.color=t,e=n.color.trim()}catch{return null}let n=/^rgba?\(([^)]+)\)$/.exec(e);if(!n?.[1])return null;let[r,i,a]=n[1].split(/[,\s/]+/).filter(Boolean).map(Number);return r===void 0||i===void 0||a===void 0||![r,i,a].every(Number.isFinite)?null:[X(r/255),X(i/255),X(a/255)]}if((n.length===3||n.length===4)&&(n=[...n.slice(0,3)].map(e=>e+e).join(``)),n.length!==6&&n.length!==8)return null;let r=Number.parseInt(n.slice(0,6),16);return Number.isFinite(r)?[X((r>>16&255)/255),X((r>>8&255)/255),X((r&255)/255)]:null}function ut([e,t,n]){let r=Math.cbrt(.4122214708*e+.5363325363*t+.0514459929*n),i=Math.cbrt(.2119034982*e+.6806995451*t+.1073969566*n),a=Math.cbrt(.0883024619*e+.2817188376*t+.6299787005*n);return[.2104542553*r+.793617785*i-.0040720468*a,1.9779984951*r-2.428592205*i+.4505937099*a,.0259040371*r+.7827717662*i-.808675766*a]}function dt([e,t,n]){let r=(e+.3963377774*t+.2158037573*n)**3,i=(e-.1055613458*t-.0638541728*n)**3,a=(e-.0894841775*t-1.291485548*n)**3;return[4.0767416621*r-3.3077115913*i+.2309699292*a,-1.2684380046*r+2.6097574011*i-.3413193965*a,-.0041960863*r-.7034186147*i+1.707614701*a]}const ft=([e,t,n])=>`#`+[e,t,n].map(e=>Math.round(Y(ct(e))*255).toString(16).padStart(2,`0`)).join(``);function pt(e,t){if(t===void 0)return null;let n=lt(e);if(!n)return null;let[r,i,a]=ut(n),o=t===`dark`?Math.max(.72,r):Math.min(.45,r);if(o===r)return ft(n);let s=Math.hypot(i,a),c=Math.atan2(a,i),l=dt([o,s*Math.cos(c),s*Math.sin(c)]);return ft([Y(l[0]),Y(l[1]),Y(l[2])])}function mt(e){return typeof e==`string`&&/^https?:\/\//i.test(e)?e:``}async function ht(e){if(!e?.callWS)return null;try{let t=await e.callWS({type:`linz_linien_austria/card_version`});if(t?.version&&t.version!==`1.0.0`)return t.version}catch{}return null}function gt(e){try{window.caches?.keys?.().then(e=>{e.forEach(e=>window.caches?.delete?.(e))})}catch{}if(e)try{window.sessionStorage?.setItem(`linz-reload-attempted-${e}`,`1`)}catch{}window.location.reload()}function _t(e){if(!e)return!1;try{return window.sessionStorage?.getItem(`linz-reload-attempted-${e}`)===`1`}catch{return!1}}function vt(e,t){return e?_t(e)?P`
      <div class="version-notice" role="alert" aria-live="assertive">
        <span>${K(`common.version_reload_stuck`,t)}</span>
      </div>
    `:P`
    <div class="version-notice" role="alert" aria-live="assertive">
      <span>${K(`common.version_update`,t,{v:e})}</span>
      <button
        class="version-reload-btn"
        type="button"
        @click=${()=>gt(e)}
      >
        ${K(`common.version_reload`,t)}
      </button>
    </div>
  `:I}const yt=c`
  :host {
...
`;function Z(e,t,n){e.dispatchEvent(new CustomEvent(t,{detail:n,bubbles:!0,composed:!0}))}function Q(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}let xt=class extends V{constructor(...e){super(...e),this._config={type:`linz-linien-austria-card`},this._computeLabel=e=>{let t=`ui.panel.lovelace.editor.card.generic.${e.name}`,n=this.hass?.localize?.(t);if(n)return n;let r=`editor.${e.name}`,i=K(r,{hassLanguage:this.hass?.language});return i===r?e.name:i},this._computeHelper=e=>{let t=`editor.${e.name}_helper`,n=K(t,{hassLanguage:this.hass?.language});return n===t?void 0:n},this._onFormChanged=e=>{let t={...e.detail.value};this._config=t,Z(this,`config-changed`,{config:t})},this._onWalkTimeChange=(e,t)=>{let n=t.target.value.trim();if(n===``){this._patchRecord(`walk_times`,e,void 0);return}let r=Number(n);if(!Number.isFinite(r)||r<=0){this._patchRecord(`walk_times`,e,void 0);return}this._patchRecord(`walk_times`,e,Math.round(r))},this._onLineColorChange=(e,t)=>{let n=t.target;this._patchRecord(`line_colors`,e,n.value)},this._onLineColorClear=e=>{this._patchRecord(`line_colors`,e,void 0)}}setConfig(e){this._config={...e}}_t(e,t){return K(e,{hassLanguage:this.hass?.language},t)}_allKnownLines(){let e=new Set,t=this._config.entity;if(t&&this.hass){let n=this.hass.states[t],r=n?.attributes?.lines_at_stop;if(Array.isArray(r))for(let t of r)typeof t==`string`&&t&&e.add(t);let i=n?.attributes?.departures;if(Array.isArray(i))for(let t of i)t.line&&e.add(t.line)}for(let t of this._config.lines??[])t&&e.add(t);return this._sortLines(Array.from(e))}_availableLines(){let e=(this._config.lines??[]).map(e=>e.trim()).filter(Boolean);return e.length>0?this._sortLines(e):this._allKnownLines()}_directionOptions(){let e=new Map,t=this._config.entity,n=t?this.hass?.states[t]?.attributes?.departures:void 0;if(Array.isArray(n))for(let t of n){let n=t.dir_code;if(n!==`H`&&n!==`R`)continue;let r=(t.direction??``).trim();if(!r)continue;let i=e.get(n)??[];i.includes(r)||i.push(r),e.set(n,i)}return[`H`,`R`].map(t=>{let n=this._t(t===`H`?`editor.direction_h`:`editor.direction_r`),r=[...e.get(t)??[]].sort((e,t)=>e.localeCompare(t,void 0,{numeric:!0})),i=r.slice(0,2).join(`, `);return{value:t,label:r.length?`${i}${r.length>2?` …`:``} (${n})`:n}})}_sortLines(e){return Array.from(new Set(e)).sort((e,t)=>{let n=parseInt(e,10),r=parseInt(t,10);return!Number.isNaN(n)&&!Number.isNaN(r)&&n!==r?n-r:e.localeCompare(t,void 0,{numeric:!0})})}_motForLine(e){let t=this._config.entity;if(!t||!this.hass)return;let n=this.hass.states[t]?.attributes?.departures;if(Array.isArray(n)){for(let t of n)if(t.line===e&&typeof t.mot==`number`)return t.mot}}_defaultColorForLine(e){return J(this._motForLine(e))}_iconForLine(e){return st(this._motForLine(e))}_toggleLine(e){let t=new Set(this._config.lines??[]);t.has(e)?t.delete(e):t.add(e);let n={...this._config};t.size===0?delete n.lines:n.lines=this._sortLines(Array.from(t)),this._config=n,Z(this,`config-changed`,{config:n})}_onCustomLineSubmit(e){let t=e.value.trim();if(!t)return;let n=new Set(this._config.lines??[]);n.add(t);let r={...this._config,lines:this._sortLines(Array.from(n))};e.value=``,this._config=r,Z(this,`config-changed`,{config:r})}_renderLinesFilter(){let e=this._allKnownLines(),t=new Set(this._config.lines??[]);return P`
      <div class="editor-section">
        <div class="section-header">${this._t(`editor.lines`)}</div>
        <div class="editor-hint">${this._t(`editor.lines_helper`)}</div>
        ${e.length===0?P`<div class="editor-hint">
              ${this._t(`editor.per_line_no_data`)}
            </div>`:P`<div class="line-chip-grid">
              ${e.map(e=>{let n=this._defaultColorForLine(e),r=this._iconForLine(e),i=t.has(e);return P`
                  <button
                    type="button"
    ...
    `}_schema(){return[{name:`entity`,required:!0,selector:{entity:{filter:{domain:`sensor`,integration:`linz_linien_austria`}}}},{name:`name`,selector:{text:{}}},{name:`hide_header`,selector:{boolean:{}}},{name:`show_hero`,selector:{boolean:{}}},{name:`show_platform`,selector:{boolean:{}}},{name:`show_absolute_time`,selector:{boolean:{}}},{name:`directions`,selector:{select:{mode:`list`,multiple:!0,options:this._directionOptions()}}},{name:`show_alerts`,selector:{boolean:{}}},{name:`pulse_live`,selector:{boolean:{}}},{name:`enable_animations`,selector:{boolean:{}}},{name:`max_departures`,selector:{number:{min:0,max:30,step:1,mode:`box`}}}]}_patchRecord(e,t,n){let r={...this._config[e]??{}};n==null||n===``?delete r[t]:r[t]=n;let i={...this._config};Object.keys(r).length===0?delete i[e]:i[e]=r,this._config=i,Z(this,`config-changed`,{config:i})}_renderPerLineSection(){let e=this._availableLines();if(e.length===0)return P`<div class="editor-hint">
        ${this._t(`editor.per_line_no_data`)}
      </div>`;let t=this._config.walk_times??{},n=this._config.line_colors??{};return P`
      <div class="editor-section">
        ...
        <div class="per-line-list">
          ${e.map(e=>{let r=t[e],i=n[e]??``,a=this._defaultColorForLine(e),o=i||a;return P`
    ...
    `}render(){let e=this._config.entity,t=typeof e==`string`&&e.length>0&&!this.hass?.states?.[e];return P`
      <div class="editor">
        <ha-form
          .hass=${this.hass}
          .data=${this._config}
        ...
        ></ha-form>
        ${t?P`<ha-alert alert-type="warning">
              ${this._t(`editor.entity_missing`,{entity:e})}
            </ha-alert>`:I}
        ${this._renderLinesFilter()}
        ${this._renderPerLineSection()}
      </div>
    `}static{this.styles=bt}};Q([Ae({attribute:!1})],xt.prototype,`hass`,void 0),Q([H()],xt.prototype,`_config`,void 0),xt=Q([De(`linz-linien-austria-card-editor`)],xt),window.customCards=window.customCards||[],window.customCards.push({type:`linz-linien-austria-card`,name:`Linz Linien Austria`,description:`Live LINZ AG LINIEN departure monitor.`,preview:!0,documentationURL:`https://github.com/rolandzeiner/linz-linien-austria`,getEntitySuggestion:(e,t)=>!t.startsWith(`sensor.`)||e?.entities?.[t]?.platform!==`linz_linien_austria`?null:{config:{type:`custom:linz-linien-austria-card`,entity:t,show_hero:!0}}});let $=class extends V{constructor(...e){super(...e),this._versionMismatch=null,this._versionCheckDone=!1,this._expandedStops=new Set}static getConfigElement(){return document.createElement(`linz-linien-austria-card-editor`)}static getStubConfig(e){let t={show_hero:!0};if(!e)return t;let n=Object.keys(e.states).find(t=>{if(!t.startsWith(`sensor.`))return!1;let n=e.states[t]?.attributes;return n!==void 0&&typeof n.stop_id==`string`&&Array.isArray(n.departures)});return n&&(t.entity=n),t}setConfig(e){if(!e||typeof e!=`object`)throw Error(`Invalid configuration / Ungültige Konfiguration`);this.config={show_hero:!0,...e}}_t(e,t){return K(e,{configLanguage:this.config?.language,hassLanguage:this.hass?.language},t)}shouldUpdate(e){if(!this.config)return!1;if(e.has(`config`))return!0;let t=e.get(`hass`);return t?this.config.entity?t.states[this.config.entity]!==this.hass.states[this.config.entity]:!1:!0}getCardSize(){return 6}getGridOptions(){return{columns:12,rows:`auto`,min_columns:6,min_rows:4}}firstUpdated(){this._maybeRunVersionCheck()}updated(e){this._maybeRunVersionCheck()}_maybeRunVersionCheck(){!this._versionCheckDone&&this.hass&&(this._versionCheckDone=!0,ht(this.hass).then(e=>{e&&this.isConnected&&(this._versionMismatch=e)}))}render(){let e={configLanguage:this.config?.language,hassLanguage:this.hass?.language};if(!this.hass)return P`<ha-card><div class="card-content">…</div></ha-card>`;if(!this.config.entity)return P`<ha-card>
        ${vt(this._versionMismatch,e)}
        <div class="card-content empty-state" role="status">
          ${this._t(`common.no_entity_picked`)}
        </div>
      </ha-card>`;let t=this.hass.states[this.config.entity];if(!t)return P`<ha-card>
        ${vt(this._versionMismatch,e)}
        <div class="card-content empty-state" role="status">
          ${this._t(`common.entity_unavailable`)}
        </div>
      </ha-card>`;let n=this.config.name||t.attributes.stop_name||t.attributes.friendly_name||``,r=t.attributes.latitude,i=t.attributes.longitude,a=t.attributes.stop_name||n,o=typeof r==`number`&&typeof i==`number`?`${r},${i}`:a?encodeURIComponent(/Linz/i.test(a)?a:`${a}, Linz`):``,s=o?mt(`https://www.google.com/maps/search/?api=1&query=${o}`):null,c=this._t(`card.open_in_maps`),l=t.attributes.departures??[],u=new Set((this.config.lines??[]).map(e=>e.trim()).filter(Boolean)),d=this.config.directions,f=new Set((Array.isArray(d)?d:[]).map(e=>String(e).trim().toUpperCase()).filter(e=>e===`H`||e===`R`)),p=this.config.walk_times??{},m=l.filter(e=>{if(u.size>0&&!u.has(e.line)||f.size>0&&e.dir_code&&!f.has(e.dir_code))return!1;let t=p[e.line];if(typeof t==`number`&&t>0){let n=this._countdownFor(e);if(n===null||n<t)return!1}return!0}),h=typeof this.config.max_departures==`number`?Math.max(0,this.config.max_departures):m.length,g=this._computeHeroGroup(m),_=g[0],v=this.config.show_hero===!1?new Set:new Set(g),ee=m.filter(e=>!v.has(e)),y=h===0?[]:ee.slice(0,h),b=st(_?.mot),x=this._userLineColor(_?.line)??q(_?.mot),S=this._accentText(this._userLineColor(_?.line)??J(_?.mot)),te=(x?`--header-color: ${x};`:``)+(S?`--header-text: ${S};`:``),C=new Set(m.map(e=>e.line).filter(Boolean)),w=(t.attributes.alerts??[]).filter(e=>{let t=e.affected_lines||[];return t.length===0||t.some(e=>C.has(e))}),T=_?.direction||``,E=this.config.show_platform?this._platformText(_):``,ne=E?`${T} · ${this._platformLabel(_,!0)} ${E}`:T,D=this.config.pulse_live!==!1,O=!!this.config.enable_animations;return P`
      <ha-card
        class=${U({"no-pulse":!D,"with-animations":O})}
      >
        ${vt(this._versionMismatch,e)}
        ${this.config.hide_header?I:P`<header class="head" style=${te}>
              <span class="icon-tile" aria-hidden="true">
                <ha-icon icon=${b}></ha-icon>
              </span>
              <div class="title-block">
                <h3 class="title">${n}</h3>
                ${ne?P`<p class="subtitle">${ne}</p>`:I}
              </div>
              ${s?P`<div class="head-actions">
                    <a
                      class="icon-action"
                      href=${s}
                      target="_blank"
        ...
        ${this.config.show_alerts!==!1&&w.length>0?this._renderAlerts(w):I}
        ${this.config.show_hero&&g.length>0?this._renderHero(g):I}
        ${h===0||y.length===0&&v.size>0?I:P`<ul class="departures" role="list">
                ${y.length===0?P`<li class="empty">
                      ${(u.size>0||f.size>0)&&l.length>0?this._t(`card.no_matches_for_filter`):this._t(`card.no_departures`)}
                    </li>`:He(y,e=>this._depKey(e),e=>this._renderRow(e))}
              </ul>`}
        <div class="foot">
          <span class="timestamp">${this._t(`card.attribution`)}</span>
        </div>
      </ha-card>
    `}_isHighPriority(e){return typeof e==`string`&&/high/i.test(e)}_renderAlerts(e){let t=[...e].sort((e,t)=>+!this._isHighPriority(e.priority)-!this._isHighPriority(t.priority)),n=this._t(`card.alerts_summary`,{count:t.length});return P`
      <section class="alerts" role="region" aria-label=${n}>
        <details>
          ...
          <ul class="alerts-list" role="list">
            ${t.map(e=>P`
                <li
                  class=${U({alert:!0,"alert-high":this._isHighPriority(e.priority)})}
                >
                  <div class="alert-title">${e.title}</div>
                  ${e.description?P`<div class="alert-body">${e.description}</div>`:I}
                  ${e.affected_lines.length?P`<div class="alert-lines">
    ...
    `}_renderHeroEntry(e){let t=this.config.show_platform?this._platformText(e):``,n=e.is_cancelled?``:(e.delay_hint??``).trim(),r=(e.is_cancelled?[]:e.stops_ahead??[]).length>0,i=this._depKey(e),a=this._expandedStops.has(i),o=`hero-stops-${this._slugify(i)}`,s=`${e.mot_name?`${e.mot_name} `:``}${e.line} ${e.direction}`,c=r?`${s}. ${this._t(a?`card.hide_stops`:`card.show_stops`,{line:e.line,direction:e.direction})}`:s;return P`
      ...
      >
        ...
        ${!e.is_cancelled&&t?P`<span class="hero-platform"
              >${this._platformLabel(e,!0)} ${t}</span
            >`:I}
        ${e.is_realtime&&!e.is_cancelled?P`<span class="rt-pill" title=${this._t(`card.realtime`)}>
        ...
        ${r?P`<ha-icon
              ...
              aria-hidden="true"
            ></ha-icon>`:I}
        ${n?P`<span class="hero-hint">${n}</span>`:I}
      </div>
    `}_renderHeroStops(e){let t=e.is_cancelled?[]:e.stops_ahead??[];if(t.length===0)return I;let n=this._depKey(e),r=this._expandedStops.has(n),i=`hero-stops-${this._slugify(n)}`,a=`${e.mot_name?`${e.mot_name} `:``}${e.line} ${e.direction}`;return P`
      <div class=${U({"hero-detail":!0,expanded:r})}>
        <div
    ...
    `}_renderRow(e){let t=this._countdownFor(e),n=typeof e.delay_minutes==`number`&&e.delay_minutes>0,r=typeof e.delay_minutes==`number`&&e.delay_minutes<0,i=t===null?`—`:t<=0?this._t(`card.now`):`${t} ${this._t(`card.minutes_short`)}`,a=this.config.show_absolute_time&&!e.is_cancelled?this._clockTimeFor(e):null,o=e.is_cancelled?``:(e.delay_hint??``).trim(),s=e.is_cancelled?[]:e.stops_ahead??[],c=this._depKey(e),l=this._expandedStops.has(c),u=`stops-${this._slugify(c)}`,d=s.length>0,f=t!==null&&t<=0&&!e.is_cancelled,p=f?this._accentText(this._userLineColor(e.line)??J(e.mot)):null,m=`${e.mot_name?`${e.mot_name} `:``}${e.line} ${e.direction} ${e.is_cancelled?this._t(`card.cancelled`):i}${a?`, ${this._t(`card.at_time`,{time:a})}`:``}${e.is_realtime?` ${this._t(`card.realtime`)}`:``}${o?`. ${o}`:``}`,h=d?`${m}. ${this._t(l?`card.hide_stops`:`card.show_stops`,{line:e.line,direction:e.direction})}`:m,g=P`
      ...
      >
        ...
        <span class="row-main">
          ...
          ${o?P`<span class="row-hint" title=${o}>${o}</span>`:I}
        </span>
        <span class="row-tail">
          ${this.config.show_platform&&!e.is_cancelled&&this._platformText(e)?P`<span
                class="row-platform"
              ...
              >`:I}
          <span
            class=${U({"row-time":!0,late:n&&!e.is_cancelled,early:r&&!e.is_cancelled,now:f})}
          >
            ${e.is_cancelled?this._t(`card.cancelled`):i}
          </span>
          ${a?P`<span class="row-clock" aria-hidden="true"
                  >${a}</span
                >${d?I:P`<span class="visually-hidden"
    ...
    `;return s.length===0?g:[g,this._renderStopsAheadPanel(s,u,l,e)]}_onExpanderKeydown(e,t,n){t&&(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),n())}_toggleStops(e){let t=new Set(this._expandedStops);t.delete(e)||t.add(e),this._expandedStops=t}_slugify(e){return e.replace(/[^a-zA-Z0-9_-]+/g,`-`)}_renderStopsAheadPanel(e,t,n,r){let i=`${r.mot_name?`${r.mot_name} `:``}${r.line} ${r.direction}`;return P`
      <li class=${U({"row-detail":!0,expanded:n})}>
        <div
    ...
    `}_renderStopsAheadTrail(e,t){let n=this._userLineColor(t.line)??q(t.mot)??`var(--linz-accent)`;return P`
      <ol
        class="stops-ahead"
        style=${Ue({"--stops-ahead-line":n})}
      >
        ${e.map((t,n)=>{let r=t.delay_minutes,i=n===e.length-1;return P`<li
            class=${U({"stops-ahead-stop":!0,terminus:i})}
          >
            <span class="stops-ahead-dot" aria-hidden="true"></span>
            <span class="stops-ahead-name">${t.name}</span>
            <span
              class=${U({"stops-ahead-time":!0,late:typeof r==`number`&&r>0,early:typeof r==`number`&&r<0})}
              >${this._clockTime(t.arrival)}</span
            >
          </li>`})}
      </ol>
    `}_clockTime(e){return!e||e.length<16?``:e.slice(11,16)}_renderLineBadge(e){let t=st(e.mot,`mdi:bus`),n=this._userLineColor(e.line),r=n?`background: ${n};`:``;return P`
      <span
        class="line-badge"
        data-mot=${e.mot??``}
        style=${r}
